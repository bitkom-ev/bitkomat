...
function init() {
    // hide all: #result,
    $("#bitkomat-bayern, #start, #intro, #weight, #result,  #header-body, #bottom").hide();
...
function initOnclickCallbacks() {
    ...
    $('#btn-bitkomat-bayern-show-qa').off('click').click(function () {
        showModal('#QAModal', '#DATAModal', '#qa-modal-body');
    });
    $('#btn-bitkomat-bayern-show-data').off('click').click(function () {
    ...
    //$('#btn-bitkomat-bayern-parteien').off('click').click(function () {  createParties('#parteien-modal-body');    showModal('#parteienModal', '', '');    });
...
function showResults(type = 'weight') {
    ...
    if (type === 'result') {
        ...
        $("#btn-bitkomat-bayern-show-weight").show(200).css("display", "inline-block");
...
`;
    ...
    if (type === 'result') {
        ...
        $("#btn-bitkomat-bayern-show-weight").show(200).css("display", "inline-block");
        $("#btn-bitkomat-bayern-show-results").hide();
        //console.log('hide button show results, show weight');
    }
    if (type === 'weight') {
        $("#text-result-edit").show(200).css("display", "inline-block");
        $("#btn-bitkomat-bayern-show-results").show(200).css("display", "inline-block");
        $("#btn-bitkomat-bayern-show-weight").hide()
...
function showBitkomat(status) {
    ...
    if (status = "edit") {
        window.location = "#top";
        $('#btn-bitkomat-bayern-skip-remaining-theses').fadeIn().addClass('inline');
    }
}

function showResult(type = 'weight') {
    $("#start, #bitkomat-bayern, #intro, #weight, #result, #header-body").hide();
    $("#" + type + "").fadeIn();
    animateBars();
...
// -' + name + '
        saveAs(imageData, now + '-bitkomat-bayern-ergebnis.png');
