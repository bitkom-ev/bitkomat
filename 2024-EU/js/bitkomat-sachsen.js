...
var T = /*#__PURE__*/ (function () {
    function T() {
        ...
        this.pdf_print_title = "Hier sehen Sie Ihr Bitkomat Sachsen Ergebnis.";
...
function showModal(id, hide, load) {
    ...
    if (load) {
        ...
        if (ergebnis) {
            ...
            file = "/2023-sachsen/faq-sachsen.html";
...
function printImageFrom(selected) {
    ...
    html2canvas(document.querySelector(selected), {
        ...
        saveAs(imageData, now + '-bitkomat-sachsen-ergebnis.png');
        ...
        if (_paq) {
            ...
            _paq.push(['trackLink', now + '-bitkomat-sachsen-ergebnis.png', 'download']);
