...
function showResults() {
  ...
  for (var list_id in data.lists) {
    ...
    var list = data.lists[list_id].name_x;
...
<span class="float-right"><i class="fa fa-chevron-down"></i></span>\
    ...
    for (var list_id in data.lists) {
text += '<li class="border-bottom list-group-item">' + getSelectionMarker(data.lists[list_id].name, data.answers[list_id][thesis_id].selection) + '\
